...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/number-of-substrings-with-only-1s/)
...
**My Solution:** [1513-Number-of-Substrings-With-Only-1s.cpp](./1513-Number-of-Substrings-With-Only-1s.cpp)
