...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/count-substrings-starting-and-ending-with-given-character/)
...
**My Solution:** [3084-Count-Substrings-Starting-and-Ending-with-Given-Character.cpp](./3084-Count-Substrings-Starting-and-Ending-with-Given-Character.cpp)
